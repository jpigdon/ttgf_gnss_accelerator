...
set all_spi_inputs_3 [lreplace $all_spi_inputs $idx $idx]
set idx [lsearch $all_spi_inputs_3 "ui_in[2]"]
set all_spi_inputs_4 [lreplace $all_spi_inputs $idx $idx]
set idx [lsearch $all_spi_inputs_4 "ui_in[3]"]
set all_spi_inputs_5 [lreplace $all_spi_inputs $idx $idx]
set idx [lsearch $all_spi_inputs_5 "ui_in[4]"]
set all_spi_inputs_6 [lreplace $all_spi_inputs $idx $idx]
set idx [lsearch $all_spi_inputs_6 "ui_in[5]"]
set all_spi_inputs_7 [lreplace $all_spi_inputs $idx $idx]
set idx [lsearch $all_spi_inputs_7 "ui_in[6]"]
set all_spi_inputs_8 [lreplace $all_spi_inputs $idx $idx]
set idx [lsearch $all_spi_inputs_8 "ui_in[7]"]
set all_spi_inputs_9 [lreplace $all_spi_inputs $idx $idx]
