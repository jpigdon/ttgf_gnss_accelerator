...
begin
    ...
    spi_read_op_data <= x"0000" when to_integer(signed(spi_op_addr_reg)) = COMMAND_ADDR else
                        ...
                        "00" & acq_i_accu_val when to_integer(signed(spi_op_addr_reg)) = ACQ_I_VAL_ADDR else
                        "00" & acq_q_accu_val when to_integer(signed(spi_op_addr_reg)) = ACQ_Q_VAL_ADDR else
                        ...
                        "00" & track_i_accu_val((0+1)*3*ACCU_OUTPUT_WIDTH-0*ACCU_OUTPUT_WIDTH-1 downto (0+1)*3*ACCU_OUTPUT_WIDTH-(0+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*0)+TRK_I_EARLY_OFFSET else
                        "00" & track_q_accu_val((0+1)*3*ACCU_OUTPUT_WIDTH-0*ACCU_OUTPUT_WIDTH-1 downto (0+1)*3*ACCU_OUTPUT_WIDTH-(0+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*0)+TRK_Q_EARLY_OFFSET else
                        "00" & track_i_accu_val((0+1)*3*ACCU_OUTPUT_WIDTH-1*ACCU_OUTPUT_WIDTH-1 downto (0+1)*3*ACCU_OUTPUT_WIDTH-(1+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*0)+TRK_I_MID_OFFSET else
                        "00" & track_q_accu_val((0+1)*3*ACCU_OUTPUT_WIDTH-1*ACCU_OUTPUT_WIDTH-1 downto (0+1)*3*ACCU_OUTPUT_WIDTH-(1+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*0)+TRK_Q_MID_OFFSET else
                        "00" & track_i_accu_val((0+1)*3*ACCU_OUTPUT_WIDTH-2*ACCU_OUTPUT_WIDTH-1 downto (0+1)*3*ACCU_OUTPUT_WIDTH-(2+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*0)+TRK_I_LATE_OFFSET else
                        "00" & track_q_accu_val((0+1)*3*ACCU_OUTPUT_WIDTH-2*ACCU_OUTPUT_WIDTH-1 downto (0+1)*3*ACCU_OUTPUT_WIDTH-(2+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*0)+TRK_Q_LATE_OFFSET else
                        "00" & track_i_accu_val((1+1)*3*ACCU_OUTPUT_WIDTH-0*ACCU_OUTPUT_WIDTH-1 downto (1+1)*3*ACCU_OUTPUT_WIDTH-(0+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*1)+TRK_I_EARLY_OFFSET else
                        "00" & track_q_accu_val((1+1)*3*ACCU_OUTPUT_WIDTH-0*ACCU_OUTPUT_WIDTH-1 downto (1+1)*3*ACCU_OUTPUT_WIDTH-(0+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*1)+TRK_Q_EARLY_OFFSET else
                        "00" & track_i_accu_val((1+1)*3*ACCU_OUTPUT_WIDTH-1*ACCU_OUTPUT_WIDTH-1 downto (1+1)*3*ACCU_OUTPUT_WIDTH-(1+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*1)+TRK_I_MID_OFFSET else
                        "00" & track_q_accu_val((1+1)*3*ACCU_OUTPUT_WIDTH-1*ACCU_OUTPUT_WIDTH-1 downto (1+1)*3*ACCU_OUTPUT_WIDTH-(1+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*1)+TRK_Q_MID_OFFSET else
                        "00" & track_i_accu_val((1+1)*3*ACCU_OUTPUT_WIDTH-2*ACCU_OUTPUT_WIDTH-1 downto (1+1)*3*ACCU_OUTPUT_WIDTH-(2+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*1)+TRK_I_LATE_OFFSET else
                        "00" & track_q_accu_val((1+1)*3*ACCU_OUTPUT_WIDTH-2*ACCU_OUTPUT_WIDTH-1 downto (1+1)*3*ACCU_OUTPUT_WIDTH-(2+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*1)+TRK_Q_LATE_OFFSET else
                        "00" & track_i_accu_val((2+1)*3*ACCU_OUTPUT_WIDTH-0*ACCU_OUTPUT_WIDTH-1 downto (2+1)*3*ACCU_OUTPUT_WIDTH-(0+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*2)+TRK_I_EARLY_OFFSET else
                        "00" & track_q_accu_val((2+1)*3*ACCU_OUTPUT_WIDTH-0*ACCU_OUTPUT_WIDTH-1 downto (2+1)*3*ACCU_OUTPUT_WIDTH-(0+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*2)+TRK_Q_EARLY_OFFSET else
                        "00" & track_i_accu_val((2+1)*3*ACCU_OUTPUT_WIDTH-1*ACCU_OUTPUT_WIDTH-1 downto (2+1)*3*ACCU_OUTPUT_WIDTH-(1+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*2)+TRK_I_MID_OFFSET else
                        "00" & track_q_accu_val((2+1)*3*ACCU_OUTPUT_WIDTH-1*ACCU_OUTPUT_WIDTH-1 downto (2+1)*3*ACCU_OUTPUT_WIDTH-(1+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*2)+TRK_Q_MID_OFFSET else
                        "00" & track_i_accu_val((2+1)*3*ACCU_OUTPUT_WIDTH-2*ACCU_OUTPUT_WIDTH-1 downto (2+1)*3*ACCU_OUTPUT_WIDTH-(2+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*2)+TRK_I_LATE_OFFSET else
                        "00" & track_q_accu_val((2+1)*3*ACCU_OUTPUT_WIDTH-2*ACCU_OUTPUT_WIDTH-1 downto (2+1)*3*ACCU_OUTPUT_WIDTH-(2+1)*ACCU_OUTPUT_WIDTH) when to_integer(signed(spi_op_addr_reg)) = TRK_BASE_ADDR+(TRK_CH_INC*2)+TRK_Q_LATE_OFFSET else
